...
import org.fc.wlt.gens.System.PSTestPB;
...
@Slf4j
@Data
public class TestPBService extends SessionModules<PSTestPB> {
	...
	@Override
	public void onPBPacket(final FramePacket pack, PSTestPB pbo, final CompleteHandler handler) {
