...
@Slf4j
@Data
public class Transfer2AnotherService extends SessionModules<PSAssetTransfer> {

	@Override
	public String[] getCmds() {		
		return new String[] { PTRSCommand.UAT.name() };
	}
	...
	@Override
	public void onPBPacket(final FramePacket pack, PSAssetTransfer pbo, final CompleteHandler handler) {
		final PRetAssetTransfer.Builder ret = PRetAssetTransfer.newBuilder();
		if(pbo != null) {
