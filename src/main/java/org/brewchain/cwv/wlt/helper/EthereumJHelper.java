...
@Slf4j
@Data
public class EthereumJHelper implements ActorService {
...
//		TXTpsAccountDetail plateformAccount = baseHelper.getUserAccount("ETH", null);
...
//	}
	 ...
	 * @throws Exception
	 */
//	public Map<String, Object> rechargeETH(CWVWltAddr accountDetail, double amount) throws Exception {
//		CWVWltAddr plateformAccount = accountHelper.getUserAccount("ETH", null,"");
//		long value = (long)amount;
